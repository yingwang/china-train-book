...
长途圈的距离已经不是一个周末可以承担的范围。从杭州东到西安北最快 5 小时 20 分，到成都东 6 小时 40 分，到桂林北接近 7 小时整。来回一趟，单是车程便已经吃掉一整天。这一档行程应当按四到五天起算，三天的安排会变成全程赶路加上走马观花，性价比反而不如中途圈。

座位选择层面，长途圈基本上把商务座变成了刚性需求。二等座坐满七小时下来腰部酸痛难以恢复，一等座体感尚可，但腿部空间仍然不足以伸展。商务座采用 1+2 布局，座椅可以接近平躺，全程提供餐食，抵达酒店之后还能保持工作和用餐的状态。从杭州东出发到这一档城市，单程商务座的票价普遍在 1500 到 2200 元之间。这一数字听上去偏贵，但按六到七小时的实际时长折算时薪并不离谱，节省下来的精力恢复时间可以多换半天有效行程。

班次方面建议优先选择早班车。杭州东在早上 7 点前后的那一班直达高铁是这一档的黄金车次，抵达目的地的时间通常正好在午餐之后，下午仍然可以安排一处轻量级行程，晚上也能睡一个完整的觉。下午发车的车次抵达目的地已经接近夜里十点，第一晚等同于被浪费。

动卧是长途圈一个容易被忽略的隐藏选项。杭州到西安、广州、深圳方向都开行 D 字头动卧，发车时间在晚上 8 点到 9 点之间，次日早上 7 点到 8 点抵达，等于节省了一晚酒店与一整天白天。动卧软卧包厢的四人间票价大约在 1100 到 1500 元之间，价格低于商务座，时间利用率反而更高。这一方式的缺点在于卧铺的睡眠质量低于酒店床位，并且只有部分线路开行，需要在 12306 上提前查询实时车次。建议采用组合用法：去程乘坐白天的高铁观赏沿途风景，回程乘坐动卧将白天留给城市本身，或者反过来安排亦可。

返程不要安排在最后一班。长途圈的晚点风险比短途圈高出不少，建议预留 1 到 2 小时的缓冲时间，否则一旦误车，代价就是一晚酒店住宿加上改签差价。
